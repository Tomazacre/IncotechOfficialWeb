...
import Navbar from "./Componentes/COM_navBar";
  ...
  return (
    <Box
      ...
      sx={{
        ...
        background: "linear-gradient(45deg, white 0%, #3348c7 100%)",
        color: "common.white",
      }}
    >
      <Navbar />
        ...
        >
          <Typography
            ...
            sx={{
              ...
              lineHeight: 1.05,
              mb: 3,
              background: "linear-gradient(40deg, #2b3aa3 15%, #58d1c9, white)",
